...
Because we don't want to reinvent the wheel, it already installs some opinionated libraries. Learn more about it in [Installed Packages](/getting-started/installed-packages).
...
This website is the example of how to use it. For now, you might want to fork it and change the `content/docs` pages to whatever you need. You might want to read the **features** to understand what benefits come with Doxi.
